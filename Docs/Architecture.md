...
**Related:** [JourneyArchitecture.md](./JourneyArchitecture.md) — Journey tab product contract; [FormaCalculationSpec.md](./FormaCalculationSpec.md) — canonical plan-target formulas; [Architecture/SourceOfTruthMap.md](./Architecture/SourceOfTruthMap.md) — per-domain read/write ownership.
