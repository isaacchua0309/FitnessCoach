...
final class AccountSyncRemoteIntegrationTests: XCTestCase {
    ...
    func testDeleteFoodPropagatesToRemoteStore() async throws {
        ...
        let uploadedEntries = try await harness.remoteStore.fetchFoodEntries(uid: userA, localDate: localDate)
        ...
        let deletedEntries = try await harness.remoteStore.fetchFoodEntries(uid: userA, localDate: localDate)
