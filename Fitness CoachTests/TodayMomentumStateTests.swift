...
final class TodayMomentumStateTests: XCTestCase {
    ...
    func testWeekProgressCountsRollingSevenDayWindow() {
        ...
        XCTAssertEqual(display.weekProgressLine, "This week: 6 of 7 days logged")
    }
