...
final class CoachContextCorrectnessValidatorTests: XCTestCase {
    ...
    func testMacrosConsumedMustMatchConfirmedFoodEntries() {
        ...
        XCTAssertEqual(result.correctedPacket.today?.nutrition?.proteinConsumed ?? -1, 28, accuracy: 0.01)
    }
    ...
    func testRemainingValuesMustMatchTargetMinusConsumed() {
        ...
        XCTAssertEqual(result.correctedPacket.today?.nutrition?.proteinRemaining ?? -1, 112, accuracy: 0.01)
