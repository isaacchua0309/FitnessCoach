...
final class OnboardingV2CopyGuardrailTests: XCTestCase {
    ...
    private func onboardingV2CopySamples() -> [String] {
        ...
        return [
            ...
            v2.PlanReveal.cutCalorieExplanation,
            v2.PlanReveal.viewMacrosCTA,
            v2.PlanReveal.savePlanCTA,
            v2.PlanReveal.signedOutSaveTrustNote,
            v2.PlanReveal.signedInSaveTrustNote,
            v2.PlanReveal.Status.sustainableTitle,
            v2.PlanReveal.Status.aggressiveDeficitTitle,
            v2.PlanReveal.Status.aggressiveDeficitBody,
            v2.PlanReveal.Reassurance.title,
            v2.PlanReveal.Reassurance.body,
            v2.PlanReveal.Reassurance.bullets.joined(separator: " "),
