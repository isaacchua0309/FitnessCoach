//
//  TodayCoachTipBuilderTests.swift
//  Fitness CoachTests
//
...
final class TodayCoachTipBuilderTests: XCTestCase {
    ...
    private func buildTip(
        ...
        isOverTarget: Bool? = nil
    ) -> AICoachTipState {
        let date = TodayDashboardFixtures.date(hour: hour)
        let overTarget = isOverTarget ?? caloriesConsumed > caloriesTarget
