//
//  TodayActivitySectionTests.swift
//  Fitness CoachTests
//
...
final class TodayActivitySectionTests: XCTestCase {
    ...
    func testDisconnectedShowsConnectCTAAndLockedCopy() {
        let activity = makeActivity(
        ...
        XCTAssertTrue(model.showsLockedIcon)
        XCTAssertEqual(model.actionTitle, FormaProductCopy.Training.Integration.connectAppleHealth)
        XCTAssertEqual(model.message, FormaProductCopy.Today.Activity.disconnectedMessage)
        XCTAssertTrue(model.accessibilitySummary.contains(FormaProductCopy.Today.Activity.sectionTitle))
    }
    ...
    func testNoActivityDataShowsEmptyStateWhenConnectedAndHealthReadsAreEmpty() {
        ...
        XCTAssertEqual(model.emptyStateLine, FormaProductCopy.Today.Activity.noDataYet)
        XCTAssertTrue(model.accessibilitySummary.contains(FormaProductCopy.Today.Activity.noDataYet))
    }
