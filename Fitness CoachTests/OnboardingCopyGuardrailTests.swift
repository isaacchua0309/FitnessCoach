...
final class OnboardingCopyGuardrailTests: XCTestCase {
    ...
    private func onboardingCopySamples() -> [String] {
        ...
        return [
            ...
            shared.PlanReveal.adjustPlanCTA,
            flow.PlanReveal.savePlanCTA,
            flow.PlanReveal.signedOutSaveTrustNote,
            flow.PlanReveal.signedInSaveTrustNote,
            ...
            shared.SavePlan.subtitleCompact,
            shared.SavePlan.finalStepLabel,
            shared.SavePlan.privacyNote,
            shared.SavePlan.signedInSubtitle,
            shared.SavePlan.planSummaryCardTitle,
            shared.SavePlan.planSummaryJourneyLabel,
            shared.SavePlan.googleSignInCTASubtitle,
