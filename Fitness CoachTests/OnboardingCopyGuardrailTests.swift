...
final class OnboardingCopyGuardrailTests: XCTestCase {
    ...
    private func onboardingCopySamples() -> [String] {
        ...
        return [
            ...
            flow.Summary.supportingParagraph,
            flow.Summary.fallbackPersonalizationSummary,
            flow.Summary.Pillars.items.map(\.title).joined(separator: " "),
            flow.Summary.Pillars.accessibilityLabel,
