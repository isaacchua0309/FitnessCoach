...
final class PlanThisWeekTests: XCTestCase {
    ...
    func testNoLogsShowsEmptyState() {
        ...
        XCTAssertEqual(
            week.emptyStateCopy,
            FormaProductCopy.PlanMissionControl.weekEmptyState
        )
    ...
    func testPartialWeekShowsAdherenceLines() {
        ...
        XCTAssertEqual(week.calorieAdherence.eligible, 7)
        XCTAssertEqual(week.caloriesLine, "Calories: 5 / 7 days")
        XCTAssertEqual(week.proteinLine, "Protein: 5 / 7 days")
        XCTAssertEqual(week.waterLine, "Water: 5 / 7 days")
    ...
    func testCompleteWeekShowsStrongOverallCopy() {
        let logs = completeWeekLogs
        let weights = completeWeekWeights
        ...
        XCTAssertEqual(week.calorieAdherence.achieved, 7)
        XCTAssertEqual(week.proteinAdherence.achieved, 7)
        XCTAssertEqual(week.waterAdherence.achieved, 7)
    ...
    func testOverCalorieDaysDoNotCountTowardAdherence() {
        ...
        XCTAssertEqual(week.proteinAdherence.achieved, 1)
        XCTAssertEqual(week.waterAdherence.achieved, 1)
        XCTAssertEqual(week.caloriesLine, "Calories: 0 / 7 days")
    }

    // MARK: - Training target unavailable
    ...
    func testTrainingTargetUnavailableWhenNoSessionsPlanned() {
        ...
        XCTAssertEqual(week.expectedTrainingDays, 0)
        XCTAssertEqual(
            week.trainingLine,
