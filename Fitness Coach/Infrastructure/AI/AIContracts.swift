...
struct AIMealImageAnalysisPreviousItem: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case uncertaintyReasons, primaryUncertainty, calorieRangeLower, calorieRangeUpper
    }
}
...
struct AIMealImageAnalysisPreviousAnalysis: Codable, Equatable, Sendable {
    ...
    init(
        summary: String,
        items: [AIMealImageAnalysisPreviousItem],
    ...
    init(from decoder: Decoder) throws {
        ...
        items = try container.decode([AIMealImageAnalysisPreviousItem].self, forKey: .items)
    ...
    private enum CodingKeys: String, CodingKey {
        case summary, items, total, primaryUncertainty, calorieRangeLower, calorieRangeUpper
    }
}
...
struct AIMealImageAnalysisResponse: Codable, Equatable, Sendable {
    ...
    init(from decoder: Decoder) throws {
        ...
        total = try container.decode(AIMealImageAnalysisTotals.self, forKey: .total)
        needsUserReview = try container.decodeIfPresent(Bool.self, forKey: .needsUserReview) ?? true
