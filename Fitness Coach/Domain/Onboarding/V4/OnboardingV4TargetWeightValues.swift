//
//  OnboardingV4TargetWeightValues.swift
//  Fitness Coach
//
//  Forma — Loss-based target weight math for v4 onboarding.
//

import Foundation

enum OnboardingV4TargetWeightValues {
    ...
    static func setGoalFromLossKg(_ lossKg: Double, in formState: inout OnboardingFormState) {
        ...
        formState.goalWeightKgText = OnboardingV4HeightWeightValues.formatStoredMetric(goal)
    }
    ...
    static func validate(formState: OnboardingFormState) throws {
        ...
        guard allowedGoals.contains(goalKg) else {
            throw OnboardingFormError.invalid(
                FormaProductCopy.Onboarding.V4.TargetWeight.unsafeGoalMessage
            )
        }
    ...
    static func currentToTargetSummary(for formState: OnboardingFormState) -> String? {
        ...
        return FormaProductCopy.Onboarding.V4.TargetWeight.currentToTargetSummary(
